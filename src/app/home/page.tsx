...
export default async function Page() {
  ...
  return (
    <div className="bg-slate-50 dark:bg-zinc-950 w-screen min-h-[91.4vh] mt-20 rounded-t-[100px] grid gap-12 lg:gap-0 lg:grid-cols-2 lg:grid-rows-1">
      <div className="row-start-1 row-end-3 border-t-2 lg:border-r-2 rounded-t-[100px] lg:rounded-tr-[0px] border-slate-400 dark:border-zinc-800 grid grid-rows-[20%,80%] justify-center items-center gap-8 lg:gap-0">
      ...
      <div className="border-t-2 lg:border-l-2 lg:rounded-tr-[100px] border-slate-400 dark:border-zinc-800 grid grid-rows-[20%,80%] justify-center items-center justify-items-center gap-8 lg:gap-0 pb-12 lg:pb-0">
